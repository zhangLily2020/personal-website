            ...
            <motion.form 
                ...
                <div className="mb-4">
                    <input type = "text"
                        ...
                        className="mb-8 w-full appearance-none rounded-lg border border-gray-900 bg-transparent px-3 py-2 
                ...
                <button type="submit" className={`mb-8 w-full rounded bg-teal-500 px-4 py-2 text-sm font-semibold text-white hover:bg-teal-400 ${isSending ? "cursor-not-allowed opacity-50" : ""}`} 
                disabled={isSending}>
